...
__all__ = [
    "DissimilaritySelectionBase",
    "ClusteringSelectionBase",
]
...
# class DissimilaritySelectionBase(SelectionBase, metaclass=ABCMeta):
...
class ClusteringSelectionBase(SelectionBase, metaclass=ABCMeta):

    @abstractmethod
    def select(self):
        """Select molecule subset based on clustering algorithm."""
        pass
